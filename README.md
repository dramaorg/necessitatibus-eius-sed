# @dramaorg/necessitatibus-eius-sed

[![CI](https://github.com/dramaorg/necessitatibus-eius-sed/workflows/CI/badge.svg)](https://github.com/dramaorg/necessitatibus-eius-sed/actions/workflows/ci.yml)
[![NPM version](https://img.shields.io/npm/v/@dramaorg/necessitatibus-eius-sed.svg?style=flat)](https://www.npmjs.com/package/@dramaorg/necessitatibus-eius-sed)
...
```
npm i @dramaorg/necessitatibus-eius-sed
```

## Usage

```js
const envSchema = require('@dramaorg/necessitatibus-eius-sed')
...
```ts
import { envSchema, JSONSchemaType } from '@dramaorg/necessitatibus-eius-sed'
...
```ts
import { envSchema } from '@dramaorg/necessitatibus-eius-sed'
...
resources that demonstrate the use of @dramaorg/necessitatibus-eius-sed in different use-cases and scenarios:

* A reference application using [Fastify with @dramaorg/necessitatibus-eius-sed and dotenv](https://github.com/lirantal/fastify-dotenv-envschema-example)
